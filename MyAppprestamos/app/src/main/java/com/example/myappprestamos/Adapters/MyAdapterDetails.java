package com.example.myappprestamos.Adapters;
...
import static com.example.myappprestamos.Utils.Util.ATRASO;
...
public class MyAdapterDetails extends RecyclerView.Adapter<MyAdapterDetails.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Details details) {
            ...
            fecha.setText(String.format(Locale.getDefault(), "%s de %s del %s", f[0], lagerMonth(details),f[2]));
